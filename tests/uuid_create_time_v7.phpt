--TEST--
uuid_create() function for UUID_TYPE_TIME_V7
--SKIPIF--
<?php 

if(!extension_loaded('uuid')) die('skip ');
if(!defined('UUID_TYPE_TIME_V7')) die('skip no UUID_TYPE_TIME_V7');

 ?>
--FILE--
<?php
        // check basic format of generated UUIDs
        $uuid = uuid_create(UUID_TYPE_TIME_V7);
