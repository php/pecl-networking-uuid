 ...
 * Stub hash: 67cd16ceafe9f1d1d1ff3b2813ef1310495cf9ae */
...
static void register_uuid_symbols(int module_number)
{
...
#endif
	REGISTER_LONG_CONSTANT("UUID_TYPE_DEFAULT", 0, CONST_CS | CONST_PERSISTENT);
	...
	REGISTER_LONG_CONSTANT("UUID_TYPE_SECURITY", UUID_TYPE_DCE_SECURITY, CONST_CS | CONST_PERSISTENT);
#endif
#if defined(UUID_TYPE_DCE_MD5)
	REGISTER_LONG_CONSTANT("UUID_TYPE_MD5", UUID_TYPE_DCE_MD5, CONST_CS | CONST_PERSISTENT);
#endif
	REGISTER_LONG_CONSTANT("UUID_TYPE_RANDOM", UUID_TYPE_DCE_RANDOM, CONST_CS | CONST_PERSISTENT);
#if defined(UUID_TYPE_DCE_SHA1)
	REGISTER_LONG_CONSTANT("UUID_TYPE_SHA1", UUID_TYPE_DCE_SHA1, CONST_CS | CONST_PERSISTENT);
#endif
	REGISTER_LONG_CONSTANT("UUID_TYPE_NULL", -1, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("UUID_TYPE_INVALID", -42, CONST_CS | CONST_PERSISTENT);
}
