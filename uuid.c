...
{
	REGISTER_LONG_CONSTANT("UUID_VARIANT_NCS",       0, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("UUID_VARIANT_DCE",       1, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("UUID_VARIANT_MICROSOFT", 2, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("UUID_VARIANT_OTHER",     3, CONST_CS | CONST_PERSISTENT);

	REGISTER_LONG_CONSTANT("UUID_TYPE_TIME",      1, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("UUID_TYPE_DCE",       2, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("UUID_TYPE_NAME",      3, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("UUID_TYPE_RANDOM",    4, CONST_CS | CONST_PERSISTENT);
